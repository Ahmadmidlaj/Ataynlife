...
const getWhatsAppUrl = (items: CartItem[], total: number) => {
  ...
  return ownerWhatsapp ? `https://wa.me/${ownerWhatsapp}?text=${encodeURIComponent(message)}` : `https://api.whatsapp.com/send?text=${encodeURIComponent(message)}`
}
...
function App() {
  ...
  const startGiftingConversation = () => {
    ...
    const url = ownerWhatsapp ? `https://wa.me/${ownerWhatsapp}?text=${encodeURIComponent(message)}` : `https://api.whatsapp.com/send?text=${encodeURIComponent(message)}`
